...
CORE_VERSION="v2.0.0"
CORE_ARCHIVE="recoba-paqet-tunnel-linux-arm64.tar.gz"
CORE_ASSET_URL="https://github.com/Recoba86/recoba-paqet-tunnel/releases/download/v2.0.0/recoba-paqet-tunnel-linux-arm64.tar.gz"
CORE_ARCHIVE_PATH="/opt/recoba-paqet-tunnel/core-cache/v2.0.0/recoba-paqet-tunnel-linux-arm64.tar.gz"
CORE_ARCHIVE_SOURCE="download"
CORE_ARCHIVE_SHA256="abc123"
CORE_BINARY_PATH="/opt/recoba-paqet-tunnel/recoba-paqet-tunnel"
...
assert_contains "$output" "DRY-RUN: recoba-paqet-tunnel command not installed" "command install path is dry-run safe"
